...
## Getting Started
Starting the App will yield a CNC experinece and offer and interaction somewhat the Windows-based ShopBot Software. The ShopBot CNC language, OpenSBP, is supported along with standard g-code. Interaction with the system is via a menuing system and command line input, virtually identical to the Sb3 ShopBot Software.
